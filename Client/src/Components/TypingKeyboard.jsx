...
export function TypingKeyboard({
  className,
  autoTypeText = "Binil Pothen Babu. Senior News Editor & Anchor at BIG TV Malayalam.   ",
  typingSpeed = [40, 120],
  scale = 0.8,
  accentColor = "#3b82f6",
    ...
    <div className={cn("tk-container", className)} {...props}>
      <style>{`
        ...
        .tk-screen {
          ...
          transform: translateZ(100px) translateY(-170px) translateZ(50px) rotateX(270deg);
